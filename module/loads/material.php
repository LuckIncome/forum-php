...
$Row = mysqli_fetch_assoc(mysqli_query($CONNECT, 'SELECT `name`, `added`, `date`, `read`, `text`, `active`, `download`, `dimg`, `dfile`, `link`, `rate`, `rateusers` FROM `loads` WHERE `id` = '.$Param['id']));
